        ...
        <div className="container mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="relative group cursor-pointer flex-shrink-0">
              <div className="relative overflow-hidden rounded-2xl shadow-md border border-slate-200 w-14 h-14 sm:w-24 sm:h-24 flex items-center justify-center bg-white group-hover:shadow-lg transition-shadow duration-300">
                <Image src="/assets/logo.jpeg" alt="Heritage Stackers Logo" width={96} height={96} className="object-contain w-full h-full" />
              </div>
            </div>
            <div className="flex flex-col">
              <h1 className="text-base font-semibold sm:text-3xl font-black tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-slate-900 to-slate-700">
